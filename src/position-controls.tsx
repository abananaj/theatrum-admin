...
// @ts-ignore
import { PanelBody, SelectControl, __experimentalGrid as Grid, __experimentalUnitControl as UnitControl } from "@wordpress/components"
// @ts-ignore
 ...
 */
addFilter("editor.BlockEdit", "chance/add-position-control", (BlockEdit: any) => {
	return (props: any) => {
		...
		const { positionType = "static", positionTop = "", positionRight = "", positionBottom = "", positionLeft = "" } = attributes
			...
			el(
				...
				el(
					...
					el(SelectControl, {
						...
						onChange: (value: string) => setAttributes({ positionType: value }),
					}),
					positionType !== "static"
						? el(
								Grid,
								{
									...
									children: [
										el(UnitControl, {
											label: "Top",
											value: positionTop,
											onChange: (next?: string) => setAttributes({ positionTop: next ?? "" }),
											style: { gridColumn: "span 2", margin: "0 auto" },
										}),
										el(UnitControl, {
											label: "Left",
											value: positionLeft,
											onChange: (next?: string) => setAttributes({ positionLeft: next ?? "" }),
										}),
										el(UnitControl, {
											label: "Right",
											value: positionRight,
											onChange: (next?: string) => setAttributes({ positionRight: next ?? "" }),
										}),
										el(UnitControl, {
											label: "Bottom",
											value: positionBottom,
											onChange: (next?: string) => setAttributes({ positionBottom: next ?? "" }),
											style: { gridColumn: "span 2", margin: "0 auto" },
										}),
									],
								},
