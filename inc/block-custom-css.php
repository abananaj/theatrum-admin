...
/**
 * Custom CSS Support for All Blocks — adds a customCSS field to the styles panel for all blocks.
  ...
  foreach ($blocks as $block) {
    ...
    if (isset($block['attrs']['customCSS']) && !empty($block['attrs']['customCSS'])) {
      ...
      $css .= $has_selector
        ...
        // Bare declarations — sanitize as a declaration list, wrapped with the block's generated class as the selector.
